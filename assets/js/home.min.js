...
},e.prototype.updateDots=function(){var i=this;null!==i.$dots&&(i.$dots.find("li").removeClass("slick-active"),i.$dots.find("li").eq(Math.floor(i.currentSlide/i.options.slidesToScroll)).addClass("slick-active"))},e.prototype.visibility=function(){var i=this;document[i.hidden]?(i.paused=!0,i.autoPlayClear()):(i.paused=!1,i.autoPlay())},i.fn.slick=function(){var i,t=this,o=arguments[0],s=Array.prototype.slice.call(arguments,1),n=t.length,l=0;for(l;n>l;l++)if("object"==typeof o||"undefined"==typeof o?t[l].slick=new e(t[l],o):i=t[l].slick[o].apply(t[l].slick,s),"undefined"!=typeof i)return i;return t},i(function(){i("[data-slick]").slick()})}),$(document).ready(function(){$(".carousel").slick({infinite:!0,autoplay:!0,arrows:!0,prevArrow:'<button type="button" class="slick-prev">&#xe601;</button>',nextArrow:'<button type="button" class="slick-next">&#xe602;</button>',autoplaySpeed:1e4,speed:450,cssEase:"linear",slidesToShow:1,dots:!0,dotsClass:"custom_paging",customPaging:function(i,e){return e+1+"/"+i.slideCount}}),$(".slick-list").focus()});